...
to go
 ...
 [
   ...
   remove-defunct-fox-families; ; see 'fox_birthdeath_routines.nls'. fox families with no adult members are removed and cubs die
    ...
    ; to mimic extra emigration
    if week-of-year = dispersal-season-begins
    [ let male-emigrants foxes with [age < 52 and sex = "male"]
      ask n-of (count male-emigrants  * 0.176) male-emigrants [die]

      let female-emigrants foxes with [age < 52 and sex = "female" ]
      ask n-of (count female-emigrants * 0.059) female-emigrants [die]

        let adult-female-emigrants foxes with [age >= 52 and sex = "female" ]
      ask n-of (count adult-female-emigrants * 0.034) adult-female-emigrants [die]
  ; print "extra deaths"
  ]
 ]
...
@#$#@#$#@
<experiments>
  <experiment name="Bristol_popstructure" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="199"/>
    <metric>year</metric>
