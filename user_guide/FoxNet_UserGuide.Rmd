---
title: "FoxNet User Guide V2.0.0"
author: "Dr Bronwyn Hradsky, Quantitative and Applied Ecology, University of Melbourne"
header-includes:
  - \usepackage{float}
  # - \usepackage{titling}
  # - \pretitle{\begin{center}
  #   \includegraphics[width=7in,height=4in]{figures/density_averaged_smooth15.png}\LARGE\\}
...
nlrx is a new R package that provides tools to setup and execute NetLogo simulations from R.  It is more efficient and easier to setup than RNetLogo.
...
An example R script for running FoxNet with some of the Mt Clay scenarios using the nlrx package is provided within the FoxNet folder - see `foxnet/r_scripts/run_model/MtClay_baseline_nlrx.R`.
