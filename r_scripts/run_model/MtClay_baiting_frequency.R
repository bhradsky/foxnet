  ...
  
{
  ...
  experiment.values <- c("monthly", "quarterly", "summer", "autumn", "winter", "spring")
  ...
  {    
    ...
    NLCommand(
      ...
      "set bait-density 0", 
      "set bait-layout-shp", paste0("\"", "gis_layers/glenelg/mtclay_baits.shp", "\""),
      "set bait-frequency \"custom*\"",
      "set custom-bait-weeks", ifelse (i == "monthly", paste0("\"[1 5 9 13 17 21 25 29 33 37 41 45 49]\""),
                                       ifelse(i == "quarterly", paste0("\"[1 13 25 39]\""), 
                                              ifelse(i == "summer", paste0("\"[1]\""), 
                                                     ifelse(i == "autumn", paste0("\"[13]\""), 
                                                            ifelse (i == "winter", paste0("\"[25]\""),
                                                                    paste0("\"[39]\"")))))),
   ...
   output$baitfrequency <- i

   write.csv(output, paste0(foxnet.path, "/outputs/mtclay/MtClay_baiting_frequency_", i, "_", corename,".csv"))
