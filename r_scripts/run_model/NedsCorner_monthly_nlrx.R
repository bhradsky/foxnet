...
nl@experiment <- experiment(
  expname = "foxnet_neds_monthly", # name of output file
  ...
  "annual-baseline-cost" = 0,
  "price-per-bait" = 1, 
  "person-days-per-baiting-round" = 0,
  "cost-per-person-day" = 0,
  "km-per-baiting-round" = 0,
  "cost-per-km-travel" = 0,
