  ...
  
{
  ...
  experiment.values <- c(0.5, 1, 2, 4, 6, 8)
  ...
  {    
    ...
    NLCommand(
      ...
      "set bait-density 0", 
      "set bait-layout-shp", paste0("\"", "gis_layers/glenelg/baiting_scenarios/mtclay_", i, "bait_km.shp", "\""),
   ...
   output$baitdensity <- i

   write.csv(output, paste0(foxnet.path, "/outputs/mtclay/MtClay_baiting_density_", i, "_", corename,".csv"))
