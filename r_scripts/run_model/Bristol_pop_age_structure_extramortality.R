  ...
  
{
    ...
    NLLoadModel(paste0(foxnet.path, "/foxnet_model/foxnet_bristol_extramortality.nlogo"),  
                nl.obj = corename)
   ...
   write.csv(output, paste0(foxnet.path, "/outputs/bristol_pop_age_structure/Bristol_pop_age_structure_extramort_45ha_", corename, ".csv"))
