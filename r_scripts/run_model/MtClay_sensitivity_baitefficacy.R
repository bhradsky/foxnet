  ...
  
{
  ...
  experiment.values <- c(0.15, 0.24, 0.36, 0.45) 
  ...
  {    
   ...
   output$baitefficacy <- i

   write.csv(output, paste0(foxnet.path, "/outputs/mtclay/mtclay_sensitivity_baitefficacy_", i, "_", corename,".csv"))
