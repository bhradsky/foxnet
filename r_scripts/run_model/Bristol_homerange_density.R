  ...
  
{
  ...
  experiment.values <- c(0.45, 0.7, 1, 2, 3, 6, 9.6)
  ...
  {    
   ...
   write.csv(output, paste0(foxnet.path, "/outputs/hr_density/HR_", i, "_", corename,".csv"))
